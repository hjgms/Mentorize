...
import { BookOpen, Calendar, Clock, GraduationCap, Star } from "lucide-react"
    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">+0.5 que semestre passado</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">+320 este mês</p>
        </CardContent>
      </Card>
    </div>
  )
