      ...
      <div className="container flex h-16 items-center justify-between">
          ...
          <Sheet>
            ...
            <SheetContent side="left" className="w-64">
              ...
              <nav className="flex flex-col gap-4">
                ...
                <Link href="/dashboard/schedule" className="flex items-center gap-2 text-sm font-medium">
                  Agendamentos
                </Link>
                <Link href="/dashboard/mentors" className="flex items-center gap-2 text-sm font-medium">
                  Monitores
                </Link>
                <Link href="/dashboard/messages" className="flex items-center gap-2 text-sm font-medium">
                  Mensagens
                </Link>
        ...
        <div className={`${isSearchOpen ? "flex" : "hidden"} md:flex items-center gap-2 flex-1 max-w-md mx-4`}>
          <div className="relative w-full">
            ...
            <Input placeholder="Buscar monitores, disciplinas..." className="pl-9 w-full" />
          </div>
